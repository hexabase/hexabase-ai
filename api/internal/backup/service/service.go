...
func (s *Service) CreateBackupStorage(ctx context.Context, workspaceID string, req domain.CreateBackupStorageRequest) (*domain.BackupStorage, error) {
...
func (s *Service) provisionStorage(ctx context.Context, storage *domain.BackupStorage) {
	// Update status to creating
	storage.Status = domain.StorageStatusCreating
	...
	config := domain.ProxmoxStorageConfig{
	...
	if err != nil {
		storage.Status = domain.StorageStatusFailed
	...
	storage.Status = domain.StorageStatusActive
...
func (s *Service) GetBackupStorage(ctx context.Context, storageID string) (*domain.BackupStorage, error) {
	return s.repo.GetBackupStorage(ctx, storageID)
}

// ListBackupStorages lists all backup storages for a workspace
func (s *Service) ListBackupStorages(ctx context.Context, workspaceID string) ([]domain.BackupStorage, error) {
	return s.repo.ListBackupStorages(ctx, workspaceID)
}

// UpdateBackupStorage updates a backup storage
func (s *Service) UpdateBackupStorage(ctx context.Context, storageID string, req domain.UpdateBackupStorageRequest) (*domain.BackupStorage, error) {
	...
	if storage.Status != domain.StorageStatusActive {
...
func (s *Service) DeleteBackupStorage(ctx context.Context, storageID string) error {
	...
	if storage.Status == domain.StorageStatusDeleting {
	...
	storage.Status = domain.StorageStatusDeleting
	s.repo.UpdateBackupStorage(ctx, storage)
...
func (s *Service) GetStorageUsage(ctx context.Context, storageID string) (*domain.BackupStorageUsage, error) {
...
func (s *Service) GetWorkspaceStorageUsage(ctx context.Context, workspaceID string) ([]domain.BackupStorageUsage, error) {
	return s.repo.GetWorkspaceStorageUsage(ctx, workspaceID)
}

// CreateBackupPolicy creates a backup policy for an application
func (s *Service) CreateBackupPolicy(ctx context.Context, applicationID string, req domain.CreateBackupPolicyRequest) (*domain.BackupPolicy, error) {
	// Get application
...
func (s *Service) createBackupCronJob(ctx context.Context, app *applicationDomain.Application, policy *domain.BackupPolicy) {
...
func (s *Service) GetBackupPolicy(ctx context.Context, policyID string) (*domain.BackupPolicy, error) {
	return s.repo.GetBackupPolicy(ctx, policyID)
}

// GetBackupPolicyByApplication retrieves a backup policy by application ID
func (s *Service) GetBackupPolicyByApplication(ctx context.Context, applicationID string) (*domain.BackupPolicy, error) {
...
func (s *Service) UpdateBackupPolicy(ctx context.Context, policyID string, req domain.UpdateBackupPolicyRequest) (*domain.BackupPolicy, error) {
...
func (s *Service) TriggerManualBackup(ctx context.Context, applicationID string, req domain.TriggerBackupRequest) (*domain.BackupExecution, error) {
	// Get backup policy
	policy, err := s.repo.GetBackupPolicyByApplication(ctx, applicationID)
	...
	execution := &domain.BackupExecution{
		ID:        uuid.New().String(),
		PolicyID:  policy.ID,
		Status:    domain.BackupExecutionStatusRunning,
		StartedAt: time.Now(),
...
func (s *Service) executeBackup(ctx context.Context, execution *domain.BackupExecution, policy *domain.BackupPolicy, backupType domain.BackupType) {
	...
	if err := s.executor.ExecuteBackup(ctx, execution, policy); err != nil {
		...
		execution.Status = domain.BackupExecutionStatusFailed
...
func (s *Service) GetBackupExecution(ctx context.Context, executionID string) (*domain.BackupExecution, error) {
	return s.repo.GetBackupExecution(ctx, executionID)
}

// ListBackupExecutions lists backup executions for an application
func (s *Service) ListBackupExecutions(ctx context.Context, applicationID string, limit, offset int) ([]domain.BackupExecution, int, error) {
	// Get policy first
	policy, err := s.repo.GetBackupPolicyByApplication(ctx, applicationID)
	if err != nil || policy == nil {
		return []domain.BackupExecution{}, 0, nil
	}
...
func (s *Service) GetLatestBackup(ctx context.Context, applicationID string) (*domain.BackupExecution, error) {
	// Get policy first
	policy, err := s.repo.GetBackupPolicyByApplication(ctx, applicationID)
	if err != nil || policy == nil {
		return nil, errors.New("no backup policy found for application")
...
func (s *Service) ProcessScheduledBackup(ctx context.Context, policyID string) (*domain.BackupExecution, error) {
	// Get policy
	policy, err := s.repo.GetBackupPolicy(ctx, policyID)
	if err != nil {
		return nil, err
...
func (s *Service) RestoreBackup(ctx context.Context, backupExecutionID string, req domain.RestoreBackupRequest) (*domain.BackupRestore, error) {
	...
	if execution.Status != domain.BackupExecutionStatusSucceeded {
...
func (s *Service) executeRestore(ctx context.Context, restore *domain.BackupRestore, execution *domain.BackupExecution) {
...
func (s *Service) GetBackupRestore(ctx context.Context, restoreID string) (*domain.BackupRestore, error) {
	return s.repo.GetBackupRestore(ctx, restoreID)
}

// ListBackupRestores lists restore operations for an application
func (s *Service) ListBackupRestores(ctx context.Context, applicationID string, limit, offset int) ([]domain.BackupRestore, int, error) {
...
func (s *Service) DownloadBackup(ctx context.Context, backupExecutionID string) (string, error) {
	...
	downloadURL := fmt.Sprintf("https://domain.hexabase.io/download/%s/%s", execution.PolicyID, execution.ID)
