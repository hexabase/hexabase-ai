...
func (r *postgresRepository) CreateProject(ctx context.Context, proj *domain.Project) error {
...
func (r *postgresRepository) GetProject(ctx context.Context, projectID string) (*domain.Project, error) {
...
func (r *postgresRepository) GetProjectByName(ctx context.Context, name string) (*domain.Project, error) {
	var proj domain.Project
...
func (r *postgresRepository) UpdateProject(ctx context.Context, proj *domain.Project) error {
...
func (r *postgresRepository) DeleteProject(ctx context.Context, projectID string) error {
	if err := r.db.WithContext(ctx).Where("id = ?", projectID).Delete(&domain.Project{}).Error; err != nil {
		return fmt.Errorf("failed to delete project: %w", err)
	}
	return nil
}

func (r *postgresRepository) GetChildProjects(ctx context.Context, parentID string) ([]*domain.Project, error) {
...
func (r *postgresRepository) AddProjectMember(ctx context.Context, member *domain.ProjectMember) error {
...
func (r *postgresRepository) RemoveProjectMember(ctx context.Context, projectID, userID string) error {
	if err := r.db.WithContext(ctx).
		...
		Delete(&domain.ProjectMember{}).Error; err != nil {
		return fmt.Errorf("failed to remove project member: %w", err)
	}
	return nil
}

func (r *postgresRepository) ListProjectMembers(ctx context.Context, projectID string) ([]*domain.ProjectMember, error) {
...
func (r *postgresRepository) AddMember(ctx context.Context, member *domain.ProjectMember) error {
	if err := r.db.WithContext(ctx).Create(member).Error; err != nil {
...
func (r *postgresRepository) GetMember(ctx context.Context, projectID, userID string) (*domain.ProjectMember, error) {
...
func (r *postgresRepository) GetMemberByID(ctx context.Context, memberID string) (*domain.ProjectMember, error) {
	var member domain.ProjectMember
...
func (r *postgresRepository) ListMembers(ctx context.Context, projectID string) ([]*domain.ProjectMember, error) {
	var members []*domain.ProjectMember
	if err := r.db.WithContext(ctx).
		Where("project_id = ?", projectID).
		Find(&members).Error; err != nil {
...
func (r *postgresRepository) UpdateMember(ctx context.Context, member *domain.ProjectMember) error {
...
func (r *postgresRepository) RemoveMember(ctx context.Context, memberID string) error {
	if err := r.db.WithContext(ctx).Where("id = ?", memberID).Delete(&domain.ProjectMember{}).Error; err != nil {
...
func (r *postgresRepository) CountMembers(ctx context.Context, projectID string) (int, error) {
	var count int64
	if err := r.db.WithContext(ctx).Model(&domain.ProjectMember{}).
		Where("project_id = ?", projectID).
...
func (r *postgresRepository) GetLastActivity(ctx context.Context, projectID string) (*domain.Activity, error) {
...
func (r *postgresRepository) GetProjectResourceUsage(ctx context.Context, projectID string) (*domain.ResourceUsage, error) {
...
func (r *postgresRepository) CreateNamespace(ctx context.Context, ns *domain.Namespace) error {
...
func (r *postgresRepository) GetNamespace(ctx context.Context, namespaceID string) (*domain.Namespace, error) {
...
func (r *postgresRepository) ListNamespaces(ctx context.Context, projectID string) ([]*domain.Namespace, error) {
...
func (r *postgresRepository) UpdateNamespace(ctx context.Context, ns *domain.Namespace) error {
...
func (r *postgresRepository) DeleteNamespace(ctx context.Context, namespaceID string) error {
	if err := r.db.WithContext(ctx).Where("id = ?", namespaceID).Delete(&domain.Namespace{}).Error; err != nil {
...
func (r *postgresRepository) ListProjects(ctx context.Context, filter domain.ProjectFilter) ([]*domain.Project, int, error) {
	var projects []*domain.Project
	var total int64
...
func (r *postgresRepository) GetProjectByNameAndWorkspace(ctx context.Context, name, workspaceID string) (*domain.Project, error) {
	var proj domain.Project
	if err := r.db.WithContext(ctx).
...
func (r *postgresRepository) GetNamespaceResourceUsage(ctx context.Context, namespaceID string) (*domain.NamespaceUsage, error) {
	// This would typically aggregate usage from Kubernetes
	// For now, return a placeholder
...
func (r *postgresRepository) GetNamespaceByName(ctx context.Context, projectID, name string) (*domain.Namespace, error) {
	var ns domain.Namespace
	if err := r.db.WithContext(ctx).
